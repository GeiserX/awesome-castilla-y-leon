...
El criterio fundamental es: **se acepta software que da soporte específico a Castilla y León, no software hecho por alguien de Castilla y León.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Castilla y León. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Castilla y León no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Castilla y León o una integración con servicios públicos de Castilla y León sí.

- **Sí:** Clientes de APIs de instituciones de Castilla y León, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Castilla y León.
- **No:** Librerías genéricas creadas por equipos de Castilla y León, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Castilla y León** (no simplemente que el autor es de Castilla y León).
2. Verificar que la PR incluye la **URL del servicio o institución de Castilla y León** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-castilla-y-leon`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Castilla y León |
