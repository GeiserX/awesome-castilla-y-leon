...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Castilla y León. No basta con que el autor sea de Castilla y León o resida aquí. Un framework genérico creado por un developer de Castilla y León no pertenece a esta lista. Un cliente para una API de servicios de Castilla y León sí.
