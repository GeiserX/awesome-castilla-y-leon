# Contribuir a Awesome Castilla y León
...
- El proyecto debe **dar soporte específico a Castilla y León** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución de Castilla y León** a la que el software da soporte (p.ej. jcyl.es, uva.es, usal.es). Esto ayuda a verificar que el proyecto es relevante para Castilla y León.
